	...
	<div id="page">
		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
			   	<li style="background-image: url(images/pix12.jpeg);">
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Bashmolevents </a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></small> 
	...
	<!-- Google Map -->
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBJnHBciqkZ3atNh7sgnMwtIee8NbKCFjI&callback=initMap">
</script>
